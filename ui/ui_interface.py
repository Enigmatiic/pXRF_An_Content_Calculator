...
################################################################################
## Form generated from reading UI file 'interfacewaicwl.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_charts = QFrame(Form)
        self.frame_charts.setObjectName(u"frame_charts")
        self.frame_charts.setStyleSheet(u"background-color: rgba(217, 217, 217, .4);")
        self.frame_charts.setFrameShape(QFrame.StyledPanel)
        self.frame_charts.setFrameShadow(QFrame.Raised)
        self.gridLayout = QGridLayout(self.frame_charts)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gv_chart = QGraphicsView(self.frame_charts)
        ...
        self.gridLayout_11.addWidget(self.frame_charts, 1, 2, 4, 1)
        ...
        self.gridLayout_11.addWidget(self.frame_tabs, 5, 2, 3, 1)
        ...
        self.tw_tabs.setCurrentIndex(4)
